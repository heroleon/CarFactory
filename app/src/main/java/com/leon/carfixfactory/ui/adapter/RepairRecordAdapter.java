...
public class RepairRecordAdapter extends BaseRecyclerAdapter<CarInfo> {
    ...
    @Override
    public void convert(BaseRecyclerHolder holder, CarInfo item, int position) {
        holder.setText(R.id.tv_car_card, item.carCard);
        ...
        holder.setText(R.id.tv_repair_desc, item.maintenanceDetail);
    }
}
